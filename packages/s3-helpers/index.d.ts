...
declare const downloadFile: (bucketName: string, fileName: string, filePath: string) => Promise<boolean | undefined>;
...
export { client, downloadDirectory, downloadFile, getPresignedPutUrl, listBuckets, listObjects, objectExistsCheck, uploadFile };
